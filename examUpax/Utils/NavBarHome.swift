...
open class ComponentNavbarHome: UIView {
    ...
    public func setComponents(
        ...
        withLogo: Bool = false,
        fontStyle: UIFont  = .systemFont(ofSize: 13),
        cornerRadius: Int = 0,
        titleCenterY: Int = 0,
    ...
    fileprivate func buildConstraint(){
        if UIDevice.current.hasTopNotch == true{
            ...
            NSLayoutConstraint.activate([
                ...
                self.containerBezel.heightAnchor.constraint(equalToConstant: 60),
        ...
        titleCenterYAnchor = NSLayoutConstraint(item: titleSection, attribute: NSLayoutConstraint.Attribute.centerY, relatedBy: NSLayoutConstraint.Relation.equal, toItem: backButton, attribute: NSLayoutConstraint.Attribute.centerY, multiplier: 1, constant: 32)
